...
BROKER_URL = 'redis://192.168.2.129:6380/0'
CELERY_RESULT_BACKEND = 'redis://192.168.2.129:6380/1'  #把任务结果存在Redis  'redis://192.168.2.125:6380/1'
...
# CELERYBEAT_SCHEDULE = {
#     'feed_spider':{
#         'task': 'schedule.tasks.test_task,get_policys',
